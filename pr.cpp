...
class QueueNode {
public:
    string request;  // Stores the request string
    ...
    static void addRequest(QueueNode*& front, QueueNode*& rear, const string& request) {
    ...
    // Function to process all requests in the queue
    static void processRequests(QueueNode*& front) {
        while (front != NULL) {
...
public:
    ...
    // Function to compare name with search term
    bool isNameEqual(const string& searchName) const {
        return name == searchName;
    }

    // Function to compare product ID with search ID
...
// Product node used for product catalog
class ProductNode {
public:
    int id;
    string name;
